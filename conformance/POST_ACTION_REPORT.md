...
| W3C conformance burst exhausted the finite 10,000-request gateway budget | Harness configuration gap | Later normative assertions observed HTTP 429 rather than product acceptance/rejection, making their results unusable | Keep production rate limiting enabled but use a 100,000-request disposable-stack budget for this dense official matrix | Exposed by run 30427157292; clean rerun required before classifying any later assertion |
