...
- CA-validated HTTPS DIDComm v2 delivery, holder-key decryption, Issue
  ...
  and
- shipped-browser organization substitution during application approval plus
  foreign-policy and organization substitution during signed verification,
  followed by successful positive controls, against exact v1.1.112 in
