...
| W3C VCDM v2 verification and issuance | Exact upstream commit `1db599924e6601555933550e0e65925a6abbd0a8` passes from an unmodified disposable worktree against the released v1.1.59 images when the product's exact related-resource allowlist is present; issuer, VC-verifier, and VP-verifier roles all execute | Release the deployment pass-through, repeat on GitHub against the immutable release, and retain the adapted VC-API entry-shape qualification |
