...
class TestTrustProfileFlow:
    ...
    async def test_create_trust_profile(
        ...
        trust_profile_data = TestDataBuilder.trust_profile(organization_id=test_organization["id"])
        ...
        # Issuer relationships are managed through the normalized registry endpoints.
    ...
    async def test_list_trust_profiles(
        ...
        profiles = await gateway_client.list_trust_profiles(organization_id=test_organization["id"])
...
class TestCredentialTemplateFlow:
    ...
    async def test_list_credential_templates(
        ...
        templates = await gateway_client.list_credential_templates(organization_id=test_organization["id"])
...
class TestPresentationPolicyFlow:
    ...
    async def test_get_presentation_policy(
        ...
        policy = await gateway_client.get_presentation_policy(age_verification_policy["id"])
    ...
    async def test_list_presentation_policies(
        ...
        policies = await gateway_client.list_presentation_policies(organization_id=test_organization["id"])
...
class TestCompleteOrganizationSetup:
    ...
    async def test_end_to_end_organization_setup(
        ...
        revocation_profile = await gateway_client.create_revocation_profile(**revocation_profile_data)
